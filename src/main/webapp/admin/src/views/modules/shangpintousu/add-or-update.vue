    ...
    <div class="addEdit-block">
        <el-form
                ...
                <el-col :span="12"  v-if="sessionTable !='shangpin' ">
                    <el-form-item class="input" v-if="type!='info'"  label="现价/积分" prop="shangpinNewMoney">
                        <el-input v-model="shangpinForm.shangpinNewMoney"
                                  placeholder="现价/积分" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="投诉类型" prop="shangpintousuTypes">
                        <el-select v-model="ruleForm.shangpintousuTypes" placeholder="请选择投诉类型">
                            <el-option
                                v-for="(item,index) in shangpintousuTypesOptions"
                    ...
                    <div v-else>
                        <el-form-item class="input" label="投诉类型" prop="shangpintousuValue">
                        <el-input v-model="ruleForm.shangpintousuValue"
                            placeholder="投诉类型" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="投诉内容" prop="minsuText">
                        <el-input type="textarea"  :readonly="ro.minsuText" v-model="ruleForm.minsuText" placeholder="投诉内容"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.minsuText" label="投诉内容" prop="minsuText">
                            <span v-html="ruleForm.minsuText"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                shangpintousuTypesOptions : [],
                shangpinOptions : [],
                yonghuOptions : [],
                rules: {
                   shangpinId: [
                              { required: true, message: '投诉商品不能为空', trigger: 'blur' },
                          ],
                   yonghuId: [
                              { required: true, message: '投诉用户不能为空', trigger: 'blur' },
                          ],
                   shangpintousuTypes: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=shangpintousu_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.shangpintousuTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    for (var o in obj){
                      ...
                      if(o=='shangpintousuTypes'){
                          this.ruleForm.shangpintousuTypes = obj[o];
                          this.ro.shangpintousuTypes = true;
                          continue;
                      }
                      if(o=='minsuText'){
                          this.ruleForm.minsuText = obj[o];
                          this.ro.minsuText = true;
                          continue;
                      }
                      if(o=='insertTime'){
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`shangpintousu/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.shangpintousuCrossAddOrUpdateFlag = false;
                                        this.parent.search();
