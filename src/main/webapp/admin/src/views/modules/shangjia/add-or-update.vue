    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="手机号" prop="shangjiaPhone">
                       <el-input v-model="ruleForm.shangjiaPhone"
                                 placeholder="手机号" clearable  :readonly="ro.shangjiaPhone"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="手机号" prop="shangjiaPhone">
                           <el-input v-model="ruleForm.shangjiaPhone"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="商家星级" prop="shangjiaXingji">
                       <el-input v-model="ruleForm.shangjiaXingji"
                                 placeholder="商家星级" clearable  :readonly="ro.shangjiaXingji"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="商家星级" prop="shangjiaXingji">
                           <el-input v-model="ruleForm.shangjiaXingji"
                                     placeholder="商家星级" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="24">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   shangjiaXingji: [
                              { required: true, message: '商家星级不能为空', trigger: 'blur' },
                          ],
                   shangjiaContent: [
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    for (var o in obj){
                      ...
                      if(o=='shangjiaIdNumber'){
                          this.ruleForm.shangjiaIdNumber = obj[o];
                          this.ro.shangjiaIdNumber = true;
                          continue;
                      }
                      if(o=='shangjiaPhone'){
                      ...
                      if(o=='shangjiaXingji'){
                          this.ruleForm.shangjiaXingji = obj[o];
                          this.ro.shangjiaXingji = true;
                          continue;
                      }
