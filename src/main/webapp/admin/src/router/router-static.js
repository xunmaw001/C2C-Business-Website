...
import center from '@/views/center'
        ...
        import shangpintousu from '@/views/modules/shangpintousu/list'
        ...
        import dictionaryShangpintousu from '@/views/modules/dictionaryShangpintousu/list'
...
const routes = [{
    ...
    ,{
        path: '/dictionaryShangpintousu',
        name: '投诉类型名称',
        component: dictionaryShangpintousu
    }
    ,{
