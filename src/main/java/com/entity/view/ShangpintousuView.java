...
public class ShangpintousuView extends ShangpintousuEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 投诉类型的值
		*/
		private String shangpintousuValue;
	...
	public ShangpintousuView() {

	}

	public ShangpintousuView(ShangpintousuEntity shangpintousuEntity) {
		try {
			BeanUtils.copyProperties(this, shangpintousuEntity);
			...
			* 获取： 投诉类型的值
			*/
			public String getShangpintousuValue() {
				return shangpintousuValue;
			}
			/**
			* 设置： 投诉类型的值
			*/
			public void setShangpintousuValue(String shangpintousuValue) {
				this.shangpintousuValue = shangpintousuValue;
			}
